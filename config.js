...
const defaultOwner = '919330810892';


// Check for the OWNERS environment variable; if not found, use the default
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || 'your number';  // '919330810892'
...
global.pairingNumber = process.env.BOT_NUMBER || 'your number';  // '919330810892'
